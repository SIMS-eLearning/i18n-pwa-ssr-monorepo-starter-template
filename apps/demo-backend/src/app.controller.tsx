...
export class AppController {
  ...
  initialContentMap = { ...iCM, 'title': 'Chima tries SSR!' }
  ...
  @Get('/web*')
  @Version('1')
  async getHelloWithSsrV1(@Req() req: Request, @Res() res: Response) {
    const userLanguage = req.body?.language || req.i18n?.language || 'en';

    // Change i18n language dynamically
  ...
  //the post request that deals with language changes
  @Post('/web*')
  @Version('1')
  async setLanguage(@Req() req: Request, @Res() res: Response) {
    ...
    return res.status(200).send({ message: 'Language updated successfully!', language });
  }
